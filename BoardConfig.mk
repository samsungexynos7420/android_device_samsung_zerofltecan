...
DEVICE_PATH := device/samsung/zerofltecan

# Assert
TARGET_OTA_ASSERT_DEVICE := zerofltecan,zerofltebmc,zerofltetmo
...
# Init
TARGET_INIT_VENDOR_LIB := //$(DEVICE_PATH):libinit_zerofltecan

# Kernel
TARGET_KERNEL_CONFIG := exynos7420-zerofltecan_defconfig
